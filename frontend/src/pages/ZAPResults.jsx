      ...
      >
        <div>
          ...
          <p className="text-gray-400">
            ...
            {data.scan_start
              ? ` Scanned: ${new Date(data.scan_start).toLocaleString()}`
              : ""}
          </p>
        </div>
                ...
                <>
                  ...
                  >
                    <td className="py-3 px-4">
                      <span
                        className={`px-2 py-1 rounded text-xs font-medium ${getRiskBg(alert.risk)}`}
                      >
                        {alert.risk}
                      </span>
                    </td>
                          ...
                          {alert.reference && (
                            <div>
                              ...
                              <a
                                ...
                                className="text-cyber-blue hover:underline ml-2"
                              >
                                {alert.reference}
                              </a>
                            </div>
